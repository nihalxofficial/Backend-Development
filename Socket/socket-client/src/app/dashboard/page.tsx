...
export default async function AnalyticsPage() {
  ...
  // const topPerformers = [
  //   { name: "Emily Chen", cgpa: 3.98, dept: "ME", age: 20 },
  //   { name: "John Smith", cgpa: 3.95, dept: "CS", age: 22 },
  //   { name: "Sarah Johnson", cgpa: 3.92, dept: "EE", age: 21 },
  //   { name: "Michael Brown", cgpa: 3.88, dept: "CE", age: 23 },
  //   { name: "Jessica Wilson", cgpa: 3.85, dept: "CS", age: 21 },
  // ];

  return (
    <div className="container mx-auto py-8 px-4 max-w-7xl">
      <h1 className="text-2xl font-bold text-zinc-100 mb-6">Dashboard Analytics</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-zinc-900/50 rounded-xl border border-zinc-800 p-6 hover:bg-zinc-900/70 transition-all">
          ...
          <div className="flex items-baseline gap-2">
            <h2 className="text-3xl font-bold text-zinc-100">{stats?.totalStudents}</h2>
        ...
        <div className="bg-zinc-900/50 rounded-xl border border-zinc-800 p-6 hover:bg-zinc-900/70 transition-all">
          ...
          <div className="flex items-baseline gap-2">
            <h2 className="text-3xl font-bold text-zinc-100">{stats?.avgCgpa}</h2>
            <span className="text-sm text-zinc-400">/ 4.0</span>
          </div>
          <p className="text-xs text-green-400 mt-2">↑ 0.12 from last semester</p>
        </div>
        ...
        <div className="bg-zinc-900/50 rounded-xl border border-zinc-800 p-6 hover:bg-zinc-900/70 transition-all">
          ...
          <div className="flex items-baseline gap-2">
            <h2 className="text-3xl font-bold text-zinc-100">{stats?.topCgpa}</h2>
            <span className="text-sm text-zinc-400">/ 4.0</span>
          </div>
        ...
        <div className="bg-zinc-900/50 rounded-xl border border-zinc-800 p-6 hover:bg-zinc-900/70 transition-all">
          ...
          <div className="flex items-baseline gap-2">
            <h2 className="text-3xl font-bold text-zinc-100">{stats?.avgAge}</h2>
      ...
      <div className="bg-zinc-900/50 rounded-xl border border-zinc-800 overflow-hidden">
        <div className="flex items-center justify-between px-6 py-4 border-b border-zinc-800">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-lg font-semibold text-zinc-100">Top Performers</h2>
          </div>
          ...
          <table className="w-full">
            <thead className="bg-zinc-800/50">
              <tr className="border-b border-zinc-700">
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-zinc-400 uppercase tracking-wider">Student Name</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-zinc-400 uppercase tracking-wider">Department</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-zinc-400 uppercase tracking-wider">Age</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-zinc-400 uppercase tracking-wider">CGPA</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-zinc-400 uppercase tracking-wider">Performance</th>
               </tr>
            </thead>
                ...
                <tr key={index} className="hover:bg-zinc-800/30 transition-colors">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm font-medium text-zinc-300">{performer?.name}</span>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className="text-sm text-zinc-400">{performer?.dept}</span>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className="text-sm text-zinc-400">{performer?.age}</span>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className="text-sm font-semibold text-yellow-400">{performer?.cgpa}</span>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center gap-2">
